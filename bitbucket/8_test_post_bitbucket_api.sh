...
BITBACKET_REQUEST_URL='https://'$BITBUCKET_ROUTE'/rest/access-tokens/1.0/users/ksmster'
BITBACKET_REQUEST_METHOD='PUT'
...
curl  -X $BITBACKET_REQUEST_METHOD --header "Content-Type: application/json" \
  --header  "Authorization: $REQUEST_SIGNATURE" \
  --data '{ "name": "che5", "permissions": [ "PROJECT_WRITE", "REPO_WRITE" ] }' \
